...
set handle [nmwiz load ../analysis_data/eda_DNA.nmd]
mol modstyle 0 0 Tube 1 10
mol modmaterial 0 0 AOEdgy
::nmdset0::Animate
animate pause

mol modstyle  0 2 Tube 1 10
mol modmaterial  0 2 AOEdgy

rotate x by -70

display depthcue on
 set ::nmdset0::cone_radius 1.0
 set ::nmdset0::cylinder_radius 0.6
 ::nmdset0::drawArrows
...
add_text_layer DNA
draw color 6
draw text " $txtx [expr $txty-($txtlncount*$txtstep)] 0 " "DNA - 1st principal mode" size 1.5 thickness 3
incr txtlncount 1
...
exec rm -f ../analysis_data/eda_dna_1.mov
exec ffmpeg -i dat/%d.tga -s 1000x750 -q:v 0 -pix_fmt yuv420p  ../analysis_data/eda_dna_1.mov
