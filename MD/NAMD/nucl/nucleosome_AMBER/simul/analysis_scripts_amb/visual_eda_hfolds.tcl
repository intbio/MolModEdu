...
#RMSD for amber notails: RMSD1 - 1.06, RMSD2- 0.74, RMSD3-0.94, RMSD4 - 0.67
...
mol load psf ../analysis_data/only_alpha_core_bb.psf
# mol addfile ../../analysis_data/only_nucl_init.pdb
# mol addfile ../../analysis_data/md_nucl.dcd  waitfor all step 50
mol addfile ../analysis_data/eda_hfolds_m${MODE}.dcd  waitfor all
...
# #add some text on new layer
 ...
 incr txtlncount 1
 draw text " $txtx [expr $txty-($txtlncount*$txtstep)] 0 " "Histone folds essential mode ${MODE}, VIEW $VIEW" size 1.5 thickness 3
 incr txtlncount 2
...
mol drawframes 0 0 $ff:$fs:$nframes
mol drawframes 0 1 $ff:$fs:$nframes
mol drawframes 0 2 $ff:$fs:$nframes
mol drawframes 0 3 $ff:$fs:$nframes
mol drawframes 0 4 $ff:$fs:$nframes
mol drawframes 0 5 $ff:$fs:$nframes
mol drawframes 0 6 $ff:$fs:$nframes
mol drawframes 0 7 $ff:$fs:$nframes

render snapshot ../analysis_data/eda_hfolds_${MODE}_view_${VIEW}_overlayed.tga



exec rm -f ../analysis_data/eda_hfolds_${MODE}_view_${VIEW}.mov
exec ffmpeg -i dat/%d.dat.tga -s 1000x750 -q:v 0 -pix_fmt yuv420p  ../analysis_data/eda_hfolds_${MODE}_view_${VIEW}.mov
# exec ffmpeg -i dat/%d.dat.tga -s 1000x750 -q:v 0 -pix_fmt yuv420p  ../analysis_data/eda_hfolds_${MODE}_view_${VIEW}.wmv
