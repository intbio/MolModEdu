...
t=ddply(prot_prot_cryst,c('PROT1_chain','PROT2_chain','PROT1_resid','PROT2_resid','PROT1_part','PROT2_part'),summarize,num=table(type)['SB']+table(type)['HB']+table(type)['vdW'])
t=subset(t,num>0)
#symmetrization
t_r=t
...
ggsave(filename="../analysis_data/int_prot_prot_full_cryst_H2AZmap_A.png",plot=a,width=7,height=7)
...
ggsave(filename="../analysis_data/int_prot_prot_full_cryst_H2AZmap_B.png",plot=b,width=7,height=7)
...
ggsave(filename="../analysis_data/int_prot_prot_full_cryst_H2AZmap_C.png",plot=c,width=7,height=7)
...
ggsave(filename="../analysis_data/int_prot_prot_full_cryst_H2AZmap_D.png",plot=d,width=7,height=7)
