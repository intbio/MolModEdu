...
df<-read.table("../analysis_data/pub_prot_rmsd_sch.csv",skip=0,header=TRUE,check.name=FALSE)
...
xlab("Residue number")+ylab("Time, ns")+ggtitle("RMSD, Side ch, NCPamb-model. Histone H3, A")+
...
scale_fill_gradient2(limits=c(0,6),low="blue",mid="green", high="red",midpoint=3.0,guide_legend(title="RMSD, A"),na.value='orange')+
scale_y_continuous(limits=c(0,1210),breaks = round(seq(0,1000, by = 100),1))+
xlab("Residue number")+ylab("Time, ns")+ggtitle("RMSD, Side ch, NCPamb-model. Histone H3, E")+
annotation_custom(h3, ymin=1000, ymax=1270, xmin=43.5,xmax=135.5)
...
xlab("Residue number")+ylab("Time, ns")+ggtitle("RMSD, Side ch, NCPamb-model. Histone H4, B")+
...
scale_fill_gradient2(limits=c(0,6),low="blue",mid="green", high="red",midpoint=3.0,guide_legend(title="RMSD, A"),na.value='orange')+
scale_y_continuous(limits=c(0,1260),breaks = round(seq(0,1000, by = 100),1))+
xlab("Residue number")+ylab("Time, ns")+ggtitle("RMSD, Side ch, NCPamb-model. Histone H4, F")+
annotation_custom(h4, ymin=1000, ymax=1335, xmin=33.5,xmax=102.5)
...
xlab("Residue number")+ylab("Time, ns")+ggtitle("RMSD, Side ch, NCPamb-model. Histone H2A, C")+
...
scale_fill_gradient2(limits=c(0,6),low="blue",mid="green", high="red",midpoint=3.0,guide_legend(title="RMSD, A"),na.value='orange')+
scale_y_continuous(limits=c(0,1200),breaks = round(seq(0,1000, by = 100),1))+
xlab("Residue number")+ylab("Time, ns")+ggtitle("RMSD, Side ch, NCPamb-model. Histone H2A, G")+
annotation_custom(h2a, ymin=1000, ymax=1270, xmin=15.5,xmax=118.5)
...
xlab("Residue number")+ylab("Time, ns")+ggtitle("RMSD, Side ch, NCPamb-model. Histone H2B, D")+
...
scale_fill_gradient2(limits=c(0,6),low="blue",mid="green", high="red",midpoint=3.0,guide_legend(title="RMSD, A"),na.value='orange')+
scale_y_continuous(limits=c(0,1220),breaks = round(seq(0,1000, by = 100),1))+
xlab("Residue number")+ylab("Time, ns")+ggtitle("RMSD, Side ch, NCPamb-model. Histone H2B, H")+
annotation_custom(h2b, ymin=1000, ymax=1290, xmin=32.5,xmax=125.5)
...
ggsave("../analysis_data/pub_prot_rmsd_sch.png",plot=q,height=12,width=12)
#plot.new()
# z <- locator(1)
quit()
