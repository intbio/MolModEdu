...
volmap density [atomselect top "resname TIP3 and name OH2"] -res 0.5 -minmax {{-52.0 -53.0 -35.0} {52.0 53.0 35.0}} -mol top -allframes -combine avg -checkpoint 10000
...
mol scaleminmax top  8 $minsc $maxsc
...
mol addrep 0
mol modstyle 9 0 VolumeSlice 0.500000 0.000000 2.000000 2.000000
mol modcolor 9 0 Volume 0
mol scaleminmax 0 9  $minsc $maxsc
...
# {{length 0.5} {width 0.05} {auto_scale 1} {fixed 1} {min 0} {max 100} {label_num 5} {text 16} {fp_format 0} {x_pos -1.0} {y_pos -1.0} {replacebar 1} {molid top} {repid 0} {showlegend 0} {legend "Color Scale:"}} {
 ::ColorScaleBar::color_scale_bar 1.5 0.1 1 1 0 100 5 16 0 -1.0 -1.0 1 top 0 1 "Number density, 1/A^3" 
...
for {set r 0} {$r < 4} {incr r 1} {
	...
	#mol modmaterial $r2 0 Material$matnum
...
render snapshot ../analysis_data/nucl_water_slice_msms.tga

set fc 0
for {set i 0} {$i <= 99} {incr i 1} {

set pos [expr $i./100]
mol modstyle 9 0 VolumeSlice $pos 0.000000 2.000000 2.000000
#rotate y by 1
display update
...
exec rm -f ../analysis_data/nucl_water_slice_msms.mov
exec ffmpeg -i dat/%d.tga -s 1000x750 -q:v 0 -pix_fmt yuv420p  ../analysis_data/nucl_water_slice_msms.mov
