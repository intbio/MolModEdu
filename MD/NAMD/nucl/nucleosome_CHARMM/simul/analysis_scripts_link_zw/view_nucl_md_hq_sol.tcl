...
mol addfile ../input/1kx5_ready.pdb

mol addfile ../analysis_data/system_aligned.pdb
 mol ssrecalc top
...
# #add some text on new layer
 ...
 draw text " $txtx [expr $txty-($txtlncount*$txtstep)] 0 " "MD simulations of nucleosome with tails and linkers (1000 ns)" size 1.5 thickness 3
 incr txtlncount 2
