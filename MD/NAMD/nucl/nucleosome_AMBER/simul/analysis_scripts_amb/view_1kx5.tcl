...
###
mol load psf ../analysis_data/1kx5_cryst_w_ions.psf
mol addfile ../analysis_data/1kx5_cryst_w_ions.pdb
 mol ssrecalc top
...
# #add some text on new layer
 ...
 draw text " $txtx [expr $txty-($txtlncount*$txtstep)] 0 " "1kx5 structure" size 1.5 thickness 3
 incr txtlncount 2
