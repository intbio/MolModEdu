...
mol addfile ../input/1kx5nt_ready.pdb waitfor all
...
##########let's center nucleosome at origin at first####
...
set selDNAF [atomselect top "(segname CHI and resid 28 to 49) or (segname CHJ and resid '-49' to '-28') "]
set selDNAB [atomselect top "(segname CHI and resid '-49' to '-28') or (segname CHJ and resid 28 to 49) "]
...
#######################
#Getting geometric center
#this is half turn
#nucleic and ( resid < 39 and resid > -39)

set n [atomselect top "nucleic and ( (segname CHI I and resid 0 ) or (segname CHJ and resid 0))"]
set vec [center_of_mass $n]

for {set i 1} {$i < 39} {incr i} {
    set n1 [atomselect top "nucleic and ( (segname CHI and resid $i ) or (segname CHJ and resid '-$i'))"]
    set n2 [atomselect top "nucleic and ( (segname CHI and resid '-$i' ) or (segname CHJ and resid $i))"]
...
$all writepdb ../analysis_data/system_aligned.pdb
$nucl writepdb ../analysis_data/only_nucl_aligned.pdb
