...
mol addfile ../../analysis_data/md_nucl.dcd  waitfor all step 10
...
# #add some text on new layer
 ...
 draw text " $txtx [expr $txty-($txtlncount*$txtstep)] 0 " "MD simulations of nucleosome with linker DNA (1000 ns), FN model" size 1.5 thickness 3
 incr txtlncount 2
...
draw color 3
draw text " $txtx [expr $txty-($txtlncount*$txtstep)] 0 " "Min groove ARGs" size 1.5 thickness 3
incr txtlncount 1
...
mol drawframes 0 0 0:5:$nframes
mol drawframes 0 1 0:5:$nframes
mol drawframes 0 2 0:5:$nframes
mol drawframes 0 3 0:5:$nframes
mol drawframes 0 4 0:5:$nframes
mol drawframes 0 5 0:5:$nframes
mol drawframes 0 6 0:5:$nframes
mol drawframes 0 7 0:5:$nframes
