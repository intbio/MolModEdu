...
wat_int_cryst<-read.csv('../../../../6md_nucl_expl/6md_1kx5_notails_ge_cons/simul/analysis_scripts/../analysis_data/wat_int_avr_df_cryst.csv')
...
#---Cryst
a1<-ggplot(data=wat_int_cryst,aes(x=INT_resname,fill=INT_part,weight=num_HB))+
geom_bar(aes(color=INT_part,y=..count..),position='stack')
a1<-a1+ggtitle('Number of hydrogen bonds with water by residue or nucleotide: crystal')
ggsave(filename="../analysis_data/int_wat_int_hist_part_cryst.png",plot=a1,width=13,height=5)

##------MD

a1<-ggplot(data=wat_int,aes(x=INT_resname,fill=INT_part,weight=num_HB))+
geom_bar(aes(color=INT_part,y=..count..),position='stack')
a1<-a1+ggtitle('Number of hydrogen bonds with water by residue or nucleotide: MD')
ggsave(filename="../analysis_data/int_wat_int_hist_part.png",plot=a1,width=13,height=5)
...
ggsave(filename="../analysis_data/int_wat_int_dna_prof_tot.png",plot=q,width=15,height=10)
...
ggsave(filename="../analysis_data/int_wat_int_dna_prof_part_cryst.png",plot=q,width=15,height=10)
...
ggsave(filename="../analysis_data/int_wat_int_dna_prof_part.png",plot=q,width=15,height=10)
