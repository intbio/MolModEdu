...
wat_int_cryst<-read.csv('../../analysis_data/int_wat_details/wat_int_raw_df_3p9_cryst.csv')
wat_int<-read.csv('../../analysis_data/int_wat_details/wat_int_raw_df_3p9.csv')
...
write.csv(wat_int, file="../../analysis_data/int_wat_details/wat_int_avr_df_3p9.csv")
write.csv(wat_int_cryst, file="../../analysis_data/int_wat_details/wat_int_avr_df_3p9_cryst.csv")
