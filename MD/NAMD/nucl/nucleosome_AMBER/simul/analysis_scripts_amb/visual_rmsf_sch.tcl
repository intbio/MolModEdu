...
color scale midpoint 0.9
color scale Offset -0.18
...
mol load pdb ../analysis_data/nucl_rmsf.pdb 
...
mol representation VDW #0.840000 20.000000 2.630000 0
mol color Beta
mol selection {segname CHA CHE and sidechain}
...
mol representation VDW #0.840000 20.000000 2.630000 0
mol color Beta
mol selection {segname CHB CHF and sidechain}
mol material AOShiny
mol addrep top
...
mol representation VDW #0.840000 20.000000 2.630000 0
mol color Beta
mol selection {segname CHC CHG and sidechain}
mol material AOShiny
mol addrep top
...
mol representation VDW # NewCartoon 0.840000 20.000000 2.630000 0
mol color Beta
mol selection {segname CHD CHH and sidechain}
mol material AOShiny
mol addrep top
...
# #add some text on new layer
 ...
 draw text " $txtx [expr $txty-($txtlncount*$txtstep)] 0 " "RMSF of nucleosome: histone side chains" size 1.5 thickness 3
 incr txtlncount 2
...
if{1 == 0} {
render snapshot ../analysis_data/nucl_rmsf_sch.tga
...
exec rm -f ../analysis_data/nucl_rmsf_sch.mov
exec ffmpeg -i dat/%d.tga -s 1000x750 -q:v 0 -pix_fmt yuv420p  ../analysis_data/nucl_rmsf_sch.mov
