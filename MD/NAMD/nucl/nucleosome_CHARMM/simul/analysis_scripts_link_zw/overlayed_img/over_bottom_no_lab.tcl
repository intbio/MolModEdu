...
mol color ColorID 6
mol selection {nucleic and backbone and resid < 73 and resid > "-73"}
mol material AOEdgy
mol addrep top
...
mol color ColorID 6
mol selection {nucleic and noh and not name P O1P O2P O3' O5' C5' and resname GUA CYT  and resid < 73 and resid > "-73"}
mol material AOEdgy
mol addrep top
...
mol representation Licorice 0.300000 10.000000 10.000000
mol color ColorID 3
mol selection {nucleic and noh and not name P O1P O2P O3' O5' C5' and resname THY ADE  and resid < 73 and resid > "-73"}
mol material AOEdgy
mol addrep top
...
# #add some text on new layer
 ...
 draw text " $txtx [expr $txty-($txtlncount*$txtstep)] 0 " "" size 1.5 thickness 6
 incr txtlncount 1
 draw text " $txtx [expr $txty-($txtlncount*$txtstep)] 0 " "View from $view side" size 1.5 thickness 6
 incr txtlncount 2
...
add_text_layer TIME
draw color 0
set time [format "Crystal" ]
draw text " $txtx [expr $txty-(26*$txtstep)] 0 " $time size 1.5 thickness 6

animate goto 0
render snapshot ../../analysis_data/$view.tga
...
add_text_layer TIME
draw color 0
set time [format "Frames 250-1000 ns" ]
draw text " $txtx [expr $txty-(27*$txtstep)] 0 " $time size 1.5 thickness 6
...
render snapshot ../../analysis_data/${view}_overlayed.tga
