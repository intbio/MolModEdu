...
/usr/bin/R --vanilla --slave < dna2_df_to_avr.r
/usr/bin/R --vanilla --slave < dna2_df_to_corr.r
/usr/bin/R --vanilla --slave < dna2_avr_analyze_geom.r
/usr/bin/R --vanilla --slave < dna2_avr_analyze_dna_param.r
/usr/bin/R --vanilla --slave < dna2_analyze_dyn.r
