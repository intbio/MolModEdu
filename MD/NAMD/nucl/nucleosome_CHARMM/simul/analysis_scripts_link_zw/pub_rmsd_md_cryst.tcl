...
set frame0_dna_n1_9 [atomselect top "nucleic and name N1 N9 and resid \"-73\" to 73" frame $rf]	 
set sel_dna_n1_9 [atomselect top "nucleic and name N1 N9 and resid \"-73\" to 73"]
...
puts $outfile "RMSD of nucleosome during MD simulations relative to crystal stucture, FN-model"
...
puts $outfile "RMSD, A"
puts $outfile "Time\tHistone fold helices C$\\alpha$\tCore C$\\alpha$\tNucleosomal (core) DNA N1,N9"
