...
ylab("Number")+ggtitle("H3, Stable atom-atom interactions with DNA, stability > 0.8")+#geom_point(data=data.frame(PROT_resid=100,tot_num=1),color='red',fill='red')+
annotation_custom(h3, ymin=-15, ymax=0, xmin=0.5,xmax=135.5)

ggsave("../analysis_data/pub_int_dna_prot2_stable_prot_prof_h3.png",plot=a,height=2.5,width=12)
...
# theme(plot.margin = unit(c(1,1,1,1), "cm"))+
ylab("Number")+ggtitle("H4, Stable atom-atom interactions with DNA, stability > 0.8")+
annotation_custom(h4, ymin=-15, ymax=0, xmin=0.5,xmax=102.5)

ggsave("../analysis_data/pub_int_dna_prot2_stable_prot_prof_h4.png",plot=a,height=2.5,width=12)
...
xlab('')+guides(colour = guide_legend(override.aes = list(shape = NA)))+#geom_point(data=data.frame(PROT_resid=100,tot_num=1),color='red',fill='red')+
# theme(plot.margin = unit(c(1,1,1,1), "cm"))+
ylab("Number")+ggtitle("H2A, Stable atom-atom interactions with DNA, stability > 0.8")+
annotation_custom(h2a, ymin=-15, ymax=0, xmin=0.5,xmax=128.5)


ggsave("../analysis_data/pub_int_dna_prot2_stable_prot_prof_h2a.png",plot=a,height=2.2,width=12)
...
# theme(plot.margin = unit(c(1,1,1,1), "cm"))+
ylab("Number")+ggtitle("H2B, Stable atom-atom interactions with DNA, stability > 0.8")+
annotation_custom(h2b, ymin=-15, ymax=0, xmin=0.5,xmax=125.5)


ggsave("../analysis_data/pub_int_dna_prot2_stable_prot_prof_h2b.png",plot=a,height=2.2,width=12)
