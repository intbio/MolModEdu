...
draw cylinder  {0 0 0} {0 0 50} radius 1
draw cylinder  {0 0 0} {0 50 0} radius 1
draw cylinder  {0 0 0} {50 0 0} radius 1
...
#volmap occupancy [atomselect top "resname TIP3 and name OH2"] -res 1.0  -allframes -combine avg -mol top

volmap occupancy [atomselect top "resname SOD"] -res 1.0  -allframes -combine avg -mol top

volmap occupancy [atomselect top "resname CLA"] -res 1.0  -allframes -combine avg -mol top
