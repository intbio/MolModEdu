#!/bin/sh
# this should be adapted for GPU cluster 

cd $SLURM_SUBMIT_DIR
module purge
module load gromacs/2018.4_gnu_gpu
...
#$PROG -v -deffnm equil1_${CASE} -rdd 1.8 -ntomp $SLURM_CPUS_PER_TASK -gpu_id 0123
...
#$PROG -v -deffnm equil2_${CASE} -rdd 1.8 -ntomp $SLURM_CPUS_PER_TASK -gpu_id 0123
...
#$PROG -v -deffnm equil3_${CASE} -rdd 1.8 -ntomp $SLURM_CPUS_PER_TASK -gpu_id 0123
...
#$PROG -v -deffnm equil4_${CASE} -rdd 1.8 -ntomp $SLURM_CPUS_PER_TASK -gpu_id 0123

#$PREP -f ${WORKDIR}/mdp/equil_long3.mdp -c ${WORKDIR}/equil3_${CASE} -r ${WORKDIR}/system_start.gro -t ${WORKDIR}/equil4_${CASE} -p ${WORKDIR}/topol.top -n ${WORKDIR}/index.ndx -o ${WORKDIR}/equil5_${CASE} -maxwarn 2
#$PROG -v -deffnm equil5_${CASE} -rdd 1.8 -ntomp $SLURM_CPUS_PER_TASK -gpu_id 0123
...
#$PROG -v -deffnm equil6_${CASE} -rdd 1.8 -ntomp $SLURM_CPUS_PER_TASK -gpu_id 0123

$PREP -f ${WORKDIR}/mdp/dynamic.mdp -c ${WORKDIR}/equil3_${CASE} -t ${WORKDIR}/equil5_${CASE} -p ${WORKDIR}/topol.top -n ${WORKDIR}/index.ndx -o ${WORKDIR}/md_${CASE}_prod_5ms -maxwarn 2
$PROG -v -deffnm md_${CASE}_prod_5ms -rdd 1.8 -ntomp $SLURM_CPUS_PER_TASK -gpu_id 0123
