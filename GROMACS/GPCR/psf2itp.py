        ...
        if len(line) > 0:
            ...
            if readprm == 'dihedral':
                ...
                if type1 == 'X' and type4 == 'X':    # look for wildcards in positions 1 and 4
                    ...
                    if (type4, type3, type2, type1) in type2dihedral:
                        ...
                        if len(type2dihedral[type4, type3, type2, type1]) == 0:
                            del type2dihedral[type4, type3, type2, type1]
                    if not (type1, type2, type3, type4) in type2dihedral:
