...
set outfile [open ../analysis_data/ion_atm_dna_all.dat w]	 
...
set sel [atomselect top "resname SOD and within $r of (nucleic)" frame $i]
set pc [$sel num]
$sel delete
set sel [atomselect top "resname CLA and within $r of (nucleic)" frame $i]
set nc [$sel num]
$sel delete

set sel [atomselect top "resname ARG LYS and name NZ CZ and within $r of (nucleic)" frame $i]
set ph [$sel num]
$sel delete

set sel [atomselect top "((resname GLU and name CD) or (resname ASP and name CG)) and name NZ CZ and within $r of (nucleic)" frame $i]
set nh [$sel num]
$sel delete
...
set total [expr $np - $nn - 294 - 80 + $nph - $nnh ]
puts $outfile "$r\t$np\t$nn\t$nph\t$nnh\t$total"
}
...
exec python2.7 myplot.py ../analysis_data/ion_atm_dna_all.dat 
