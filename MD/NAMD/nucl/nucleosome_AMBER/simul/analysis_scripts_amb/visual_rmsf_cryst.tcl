...
mol load pdb ../analysis_data/nucl_rmsf_cryst.pdb 
...
# #add some text on new layer
 ...
 draw text " $txtx [expr $txty-($txtlncount*$txtstep)] 0 " "RMSF of nucleosome" size 1.5 thickness 3
 incr txtlncount 2
...
exec rm -f ../analysis_data/nucl_rmsf_cryst.mov
exec ffmpeg -i dat/%d.tga -s 1000x750 -q:v 0 -pix_fmt yuv420p  ../analysis_data/nucl_rmsf_cryst.mov
