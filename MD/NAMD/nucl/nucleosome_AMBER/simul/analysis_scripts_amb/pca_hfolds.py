...
def main():
	...
	dcd.setAtoms(pdb.select(alpha_core)) # this will determine what set to use for superposition and covariance
...
#Histone folds
	...
	print "Num atoms:", len(pdb.select(alpha_core).getIndices())
