...
# #add some text on new layer
 ...
 draw text " $txtx [expr $txty-($txtlncount*$txtstep)] 0 " "MD simulations of NCP with truncated tails (1000 ns, 10 ns smoothing)" size 1.5 thickness 3
 incr txtlncount 2
...
# mol modmaterial 9 0 AOEdgy
# mol modmaterial 10 0 AOEdgy
