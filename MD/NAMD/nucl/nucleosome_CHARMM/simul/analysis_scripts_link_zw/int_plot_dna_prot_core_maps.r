...
dna_prot_cryst<-read.csv('../analysis_data/dna_prot_avr_df.csv')
...
t=ddply(dna_prot_cryst,c('DNA_chain','PROT_chain','DNA_resid','PROT_resid'),summarize,num=sum(av_num))
#symmetrization
#combine DNA
q=seq(93,-93,-1)
...
ggsave(filename="../analysis_data/int_dna_prot_core_map_A.png",plot=a,width=7,height=7)
...
ggsave(filename="../analysis_data/int_dna_prot_core_map_B.png",plot=b,width=7,height=7)
...
ggsave(filename="../analysis_data/int_dna_prot_core_map_C.png",plot=c,width=7,height=7)
...
ggsave(filename="../analysis_data/int_dna_prot_core_map_D.png",plot=d,width=7,height=7)
