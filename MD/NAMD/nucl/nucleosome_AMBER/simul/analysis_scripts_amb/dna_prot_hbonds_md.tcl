...
set outfile [open ../analysis_data/dna_prot_hbonds_md.dat w]	
#set sel1 [atomselect top "segname CHI and resid '$r1'" frame $i]

puts $outfile "Hydrogen bonds between DNA and protein"
...
set hbonds1 [lindex [measure hbonds 3.0 30 $sel1 $sel2] 1]
set hbonds2 [lindex [measure hbonds 3.0 30 $sel2 $sel1] 1]
