...
set na_sod_rdf [measure gofr $sod $cla rmax 15 usepbc 1 first 5000 last 9999]
...
puts $outfile "RDF"
puts $outfile "Distance\tP-SOD (last 500ns)\tP-CLA (last 500ns)\tP-SOD (first 10ns)\tP-CLA (first 10)\tNA-SOD (last 500ns)"
