...
set av_pos [measure avpos $sel_all first 2500 last $nframes step 1]
# set av_pos [measure avpos $sel_all first 9100 last 10000 step 1]
...
set frame_ref [atomselect top $alpha_hfolds_ca frame 0]	 
set sel [atomselect top $alpha_hfolds_ca frame 1]	
