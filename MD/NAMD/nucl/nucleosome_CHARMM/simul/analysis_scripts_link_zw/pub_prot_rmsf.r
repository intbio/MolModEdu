...
a<-ggplot(data=df[df$Chain=='H3_1' & df$Resid >=44 & df$Resid <=131,],aes(x=Resid,y=RMSF,color=data))+
...
e<-ggplot(data=df[df$Chain=='H3_2' & df$Resid >=44 & df$Resid <=131,],aes(x=Resid,y=RMSF,color=data))+
geom_line(size=1)+geom_point(size=2)+ylim(0.2,2.0)+
...
b<-ggplot(data=df[df$Chain=='H4_1' & df$Resid >=24 & df$Resid <=98,],aes(x=Resid,y=RMSF,color=data))+
geom_line(size=1)+geom_point(size=2)+ylim(0.2,2.0)+
...
f<-ggplot(data=df[df$Chain=='H4_2' & df$Resid >=24 & df$Resid <=98,],aes(x=Resid,y=RMSF,color=data))+
geom_line(size=1)+geom_point(size=2)+ylim(0.2,2.0)+
...
ggsave("../analysis_data/pub_prot_rmsf.png",plot=q,height=12,width=12)
