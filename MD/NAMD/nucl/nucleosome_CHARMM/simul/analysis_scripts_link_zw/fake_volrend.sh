...
######        USAGE
#
# ./fake_voldend psffile pdbfile dxfile isosurfacesteps startisovalue stopisovalue vmdcolorid 
# red = 1 blue = 0 green = 7

#Examples
# ./fake_volrend_colorbar.sh only_nucl_init.psf only_nucl_aligned.pdb water_volmap.dx 10 0.035 0.05 BGR
 
# Один ион (хлор):
# ./fake_volrend.sh ../analysis_data/only_nucl_init.psf ../analysis_data/only_nucl_aligned.pdb ../analysis_data/ion_cla_volmap.dx 9 0.00035 0.002 7
# Оба иона:
# ./fake_volrend.sh ../analysis_data/only_nucl_init.psf ../analysis_data/only_nucl_aligned.pdb ../analysis_data/ion_sod_volmap.dx 9 0.00035 0.002 1
##list of keys:
...
opacitystart=0.03
opacitystop=0.25
firstheader="Chloride distribution in Nucleosome"
...
mol modmaterial "`echo $i "+" $numofrepr | bc`" 0 Material"`echo $i "+ 22" | bc`"
" >> dummy.tcl
done
...
vmdpy -e dummy.tcl
rm dummy.tcl
# rm -f nucl_iso_cl_ions.mov
# ffmpeg -i dat/%d.tga -sameq  nucl_iso_cl_ions.mov
# rm -rf dat
