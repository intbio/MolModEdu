...
# set alpha_hfolds_bb "((segname CHA CHE and (resid 64 to 78 or resid 86 to 114 or resid 121 to 131)) or (segname CHB CHF and (resid 31 to 41 or resid 49 to 76 or resid 83 to 93))  or (segname CHC CHG and (resid 27 to 37 or resid 45 to 73 or resid 80 to 89)) or (segname CHD CHH and (resid 34 to 45 or resid 53 to 81 or resid 88 to 98))) and name CA O C N"
...
set dna_bb "segname CHI CHJ and name P O5' C5' C4' C3' O3'"
set dna_p "segname CHI CHJ and name P"

#set p [atomselect top "	"]
set alphabb0 [atomselect top $alpha_hfolds_bb frame 0]
set alphaca0 [atomselect top $alpha_hfolds_ca frame 0]
