...
#set last 1000
axes location off
source render_scripts/input_param.tcl
#source aa_hydro_scale.tcl
#source colorbar.tcl
source render_scripts/add_text_layer.tcl

nmwiz load ../analysis_data/eda_hfolds.nmd

#loading molecule
# mol load psf ../../input/1kx5nt_ready.psf
# mol addfile ../../analysis_data/md_nucl_solv.dcd last 30 waitfor all
