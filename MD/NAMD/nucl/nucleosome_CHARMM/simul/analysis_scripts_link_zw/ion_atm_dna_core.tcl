...
set outfile [open ../analysis_data/ion_atm_dna_core.dat w]	 
...
puts $outfile "Number of ions, charges and total charge within certain distance from NCP DNA"
...
set sel [atomselect top "resname SOD and within $r of (nucleic and resid < 74 and resid > '-74')" frame $i]
set pc [$sel num]
$sel delete
set sel [atomselect top "resname CLA and within $r of (nucleic and resid < 74 and resid > '-74')" frame $i]
set nc [$sel num]
$sel delete

set sel [atomselect top "resname ARG LYS and name NZ CZ and within $r of (nucleic and resid < 74 and resid > '-74')" frame $i]
set ph [$sel num]
$sel delete

set sel [atomselect top "((resname GLU and name CD) or (resname ASP and name CG)) and within $r of (nucleic and resid < 74 and resid > '-74')" frame $i]
set nh [$sel num]
$sel delete

set sel [atomselect top "(nucleic) and name P  and within $r of (nucleic and resid < 74 and resid > '-74')" frame $i]
set ld [$sel num]
$sel delete
...
exec python2.7 myplot_ions.py ../analysis_data/ion_atm_dna_core.dat 
