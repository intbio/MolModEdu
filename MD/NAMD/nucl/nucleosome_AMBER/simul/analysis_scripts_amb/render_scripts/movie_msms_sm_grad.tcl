...
#loading molecule
  ...
  mol addfile ../../analysis_data/md_nucl_solv.dcd last 200 waitfor all
...
# #add some text on new layer
 ...
 draw text " $txtx [expr $txty-($txtlncount*$txtstep)] 0 " "MD simulations of NCP with truncated tails (100 ns, 1 ns smoothing)" size 1.5 thickness 3
 incr txtlncount 2
...
add_text_layer TIME
draw color 0
set time [format "Time: %5.1f ns" [expr $i * 0.1]]
