...
# #add some text on new layer
 ...
 # draw text " $txtx [expr $txty-($txtlncount*$txtstep)] 0 " "MD simulations of NCP with tails and linkers (1000 ns) CHARMM" size 1.5 thickness 3
 incr txtlncount 1
 draw text " $txtx [expr $txty-($txtlncount*$txtstep)] 0 " "View from $view side" size 1.5 thickness 3
 incr txtlncount 2
...
draw text " $txtx [expr $txty-(26*$txtstep)] 0 " $time size 1.5 thickness 3
