...
t=ddply(dna_prot,c('DNA_chain','PROT_chain','DNA_resid','PROT_resid'),summarize,num=sum(av_num))
#symmetrization
#combine DNA
q=seq(93,-93,-1)
...
ggtitle("Interactions of H3 chain A with DNA, MD")+
...
ggsave(filename="../analysis_data/int_dna_prot_full_map_A.png",plot=a,width=14,height=7)
...
ggtitle("Interactions of H4 chain B with DNA, MD")+
...
ggsave(filename="../analysis_data/int_dna_prot_full_map_B.png",plot=b,width=7,height=7)
...
ggtitle("Interactions of H2A chain C with DNA, MD")+
geom_hline(yintercept = c(16,22,26,37,46,73,79,89,90,97), colour="green", linetype = "longdash",size=0.5)+
...
ggtitle("Interactions of H2B chain D with DNA, MD")+
...
ggsave(filename="../analysis_data/int_dna_prot_full_map_D.png",plot=d,width=14,height=7)
...
ggtitle("Interactions of H3 chain E with DNA, MD")+
geom_hline(yintercept = c(44,57,63,77,85,114,120,131), colour="green", linetype = "longdash",size=0.5)+
...
ggsave(filename="../analysis_data/int_dna_prot_full_map_E.png",plot=e,width=14,height=7)
...
ggtitle("Interactions of H4 chain F with DNA, MD")+
geom_hline(yintercept = c(24,29,30,41,49,76,82,93), colour="green", linetype = "longdash",size=0.5)+

annotation_custom(h4r, xmin=-2, xmax=0, ymin=0.5,ymax=102.5)+
# annotation_custom(h4r2, xmin=-42.0, xmax=-34, ymin=0.5,ymax=102.5)+

scale_y_continuous(limits=c(0.5,102.5),breaks=seq(0,110,10),minor_breaks = seq(0, 102, 2))+
scale_x_continuous(limits=c(-10.0,40),breaks=seq(-90,90,10),minor_breaks = seq(-90, 90, 2))

ggsave(filename="../analysis_data/int_dna_prot_full_map_F.png",plot=f,width=7,height=7)
...
ggtitle("Interactions of H2A chain G with DNA, MD")+
geom_hline(yintercept = c(16,22,26,37,46,73,79,89,90,97), colour="green", linetype = "longdash",size=0.5)+
...
ggtitle("Interactions of H2B chain H with DNA, MD")+
geom_hline(yintercept = c(37,49,55,84,90,102,103,123), colour="green", linetype = "longdash",size=0.5)+
# geom_hline(yintercept = c(16,22,26,37,46,73,79,89,90,97), colour="green", linetype = "longdash",size=0.5)+
...
ggsave(filename="../analysis_data/int_dna_prot_full_map_H.png",plot=h,width=14,height=7)
