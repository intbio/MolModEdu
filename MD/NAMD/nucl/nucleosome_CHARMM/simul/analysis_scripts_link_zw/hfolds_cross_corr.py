...
"""
Plot cross-cor for histone folds
...
#Now let's do covariance
	...
	cross_corr = pickle.load( open( "../analysis_data/hfolds_cross_corr.p", "rb" ) )
	...
	sp.set_title("Cross-correlation matrix for histone folds backbone.")
	...
	fig4.tight_layout()
	fig4.savefig("../analysis_data/pca_hfolds_cross_corr.png",dpi=(200))
