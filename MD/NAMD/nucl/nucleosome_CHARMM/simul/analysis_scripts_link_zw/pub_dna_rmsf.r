...
xlab("Nucleotide number from dyad (5' to 3')")+ylab("RMSF, Å")+ggtitle("RMSF, P-atoms, core nucleosome DNA, FN-model.")
...
ggsave("../analysis_data/pub_dna_rmsf.png",plot=a,height=5,width=10)
